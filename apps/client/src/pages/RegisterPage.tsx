    ...
    <div className="max-w-md mx-auto px-4 py-16">
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
        <div className="text-center mb-8">
          ...
          <h1 className="section-title">注册</h1>
          <p className="section-subtitle">开启你的命运探索之旅</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="glass-card p-8 space-y-5">
          ...
          <div>
            <label className="block text-mystic-text-secondary mb-2 text-sm">昵称</label>
            <input
              type="text"
              required
              value={form.name}
          ...
          <p className="text-center text-sm text-mystic-text-secondary">
            已有账号？{' '}
            <Link to="/login" className="text-mystic-accent hover:underline">登录</Link>
          </p>
        </form>
      </motion.div>
    </div>
